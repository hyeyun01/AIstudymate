...
if st.button("🧪 학습 성향 분석 시작"):
    ...
    study_tips = {
    0: {  # 병아리 탐험가 🐣
        "analysis": """- 기초 개념 이해와 반복 학습을 잘해요.
                - 간단한 문제를 단계적으로 푸는 활동을 좋아해요.
                - 복잡한 문제를 혼자 탐구하는 것이 부족해요.
                - 심화 문제를 해결하는 경험이 약해요.""",
        "method": """- 노트에 개념과 예제 문제를 정리해보기
                - 문제 풀이 과정을 말로 설명하며 반복
                - 쉬운 문제부터 단계별로 연습하여 자신감 쌓기""",
        "role": "친구와 함께 공부할 때는 ‘조력자’ 역할을 맡아, 친구의 이해를 돕고 기본기 점검을 지원하면 좋아요."
    },
    1: {  # 논리왕 🤓
        "analysis": """- 논리적으로 문제를 분석하고 체계적으로 푸는 것을 잘해요.
                - 혼자서 단계별 문제 해결과 계획 세우기를 좋아해요.
                - 협력 학습이나 토론을 통한 이해는 부족해요.
                - 창의적 문제 접근 경험이 약해요.""",
        "method": """- 문제 풀이 계획표 작성 후 혼자 풀이
                - 어려운 문제를 여러 방법으로 해결하며 사고력 확장
                - 풀이 과정을 글로 정리하여 논리 구조 점검""",
        "role": "친구와 함께 공부할 때는 ‘분석가’ 역할을 맡아, 문제 접근 방법과 전략을 제시하면 좋아요."
    },
    2: {  # 친구왕 🦄
        "analysis": """- 친구와 함께 공부하고 토론하며 이해하는 것을 잘해요.
                - 그룹 활동과 발표를 좋아해요.
                - 혼자서 계획 세우고 문제를 분석하는 능력은 부족해요.
                - 자기주도적 학습 경험이 약해요.""",
        "method": """- 그룹 토론과 발표를 통해 문제 풀이 공유
                - 문제를 서로 설명하고 역할 분담 후 결과 정리
                - 글쓰기나 말로 설명하기로 이해한 내용을 기록""",
        "role": "친구와 함께 공부할 때는 ‘조정자/소통자’ 역할을 맡아, 토론과 역할 분담을 주도하면 좋아요."
    },
    3: {  # 문제 해결 마스터 🕵️‍♂️
        "analysis": """- 복잡한 문제를 다양한 방법으로 탐구하고 해결하는 것을 잘해요.
                - 심화 문제와 응용 활동을 좋아해요.
                - 기초 개념 반복 학습은 부족해요.
                - 학습 루틴 관리 경험이 약해요.""",
        "method": """- 문제 변형 및 응용 문제를 스스로 풀어보기
                - 학습 내용을 글로 정리하거나 친구에게 설명
                - 기초 개념 복습과 실수 분석으로 약점 보완""",
        "role": "친구와 함께 공부할 때는 ‘문제 해결사’ 역할을 맡아, 심화 문제와 응용 활동을 이끌면 좋아요."
    }
}
