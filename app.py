...
if st.button("🧪 학습 성향 분석 시작"):
    ...
    0: {
        ...
        "partner_role": "친구와 함께 공부할 때는 ‘조력자’ 역할을 맡아, 기본 개념을 함께 확인하고 지원하면 좋아요."
    },
    1: {
        "name": "논리왕 🤓",
        "analysis": [
        ...
        "partner_role": "친구와 함께 공부할 때는 ‘분석가’ 역할을 맡아, 문제 접근 방법과 전략을 제시하면 좋아요."
    },
    2: {
        "name": "친구왕 🦄",
        "analysis": [
        ...
        "partner_role": "친구와 함께 공부할 때는 ‘촉진자’ 역할을 맡아, 토론을 이끌고 의견을 정리하면 좋아요."
    },
    3: {
        "name": "문제 해결 마스터 🕵️‍♂️",
        "analysis": [
        ...
        "partner_role": "친구와 함께 공부할 때는 ‘문제 해결사’ 역할을 맡아, 어려운 문제를 시도하고 전략을 공유하면 좋아요."
    }
}

    study_tips = study_tips[cluster]
    ...
    st.divider()
    st.subheader("📇 나의 프로필 카드")
    st.markdown(f"""
        **{study_tips['name']}**

        **학습 스타일 분석:**  
        - {study_tips['analysis'][0]}  
        - {study_tips['analysis'][1]}  
        - {study_tips['analysis'][2]}  
        - {study_tips['analysis'][3]}  
