...
def match_partners(df_students):
    ...
    # ---------------------------------------------
    # 2) 기존 scaler + KMeans용 컬럼명 맞추기
    # ---------------------------------------------
    df_students['competency_label_1'] = df_students['Analytical']
    df_students['competency_label_2'] = df_students['Collaborative']
    df_students['competency_label_3'] = df_students['SelfDirected']
    df_students['competency_label_4'] = df_students['Questioning']

    features = ['competency_label_1','competency_label_2','competency_label_3','competency_label_4']
    ...
    # ---------------------------------------------
    # 4) 유클리드 거리 기반 추천 (자신과 가장 가까운 학생 제외)
    # ---------------------------------------------
    ...
    # 최종 반환
    return df_students[['ID','grade','Cluster','Cluster_Name','Recommended_Partner']]
